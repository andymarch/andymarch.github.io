...
{%- assign search_text = post_title -%}
{%- if post.layout == "tweet" -%}
  {%- assign search_text = post.excerpt | strip_html | strip_newlines | truncate: 200 -%}
  {%- assign post_type = "Tweet" -%}
  {%- assign post_title = "Tweet" -%}
{%- endif -%}
{%- assign post_search = search_text | append: " " | append: post_type | append: " " | append: post_year | downcase -%}
